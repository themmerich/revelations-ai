...
window.TRANSLATIONS = {
  ...
  "hero.lede": {
    ...
    en: "Clive Barker — author, director, painter. Half a century between heaven, hell and everything that dreams in between."
  },
  "hero.meta": {
    de: "Liverpool, 1952 — Los Angeles, heute",
    en: "Liverpool, 1952 — Los Angeles, today"
  },
  "hero.scroll": { de: "Scrollen", en: "Scroll" },

  /* Marquee */
  "marquee.line": {
    de: "Horror&nbsp;·&nbsp;Fantasy&nbsp;·&nbsp;Malerei&nbsp;·&nbsp;Film&nbsp;·&nbsp;Theater&nbsp;·&nbsp;Literatur&nbsp;·&nbsp;",
    en: "Horror&nbsp;·&nbsp;Fantasy&nbsp;·&nbsp;Painting&nbsp;·&nbsp;Film&nbsp;·&nbsp;Theatre&nbsp;·&nbsp;Literature&nbsp;·&nbsp;"
  },

  /* Bio */
  "bio.title": { de: "<em>Biografie</em>", en: "<em>Biography</em>" },
  "bio.figcap": {
    de: "Joel&rsquo;s Ghost · Öl auf Leinwand · © Clive Barker",
  ...
  /* Footer */
  "footer.big": {
    de: "Alles Fleisch<br /><em>ist Geschichte.</em>",
    en: "All flesh<br /><em>is story.</em>"
  },
  "footer.m1": {
    de: "Sämtliche Gemälde &amp; Zeichnungen © Clive Barker · mit Dank an das Revelations-Archiv (clivebarker.info)",
    en: "All paintings &amp; drawings © Clive Barker · with thanks to the Revelations archive (clivebarker.info)"
  },
  "footer.m2": {
    de: "Konzept, Text, Code &amp; Motion: Claude Fable 5 · Anthropic · 2026 — inoffizielles Fan-Projekt",
    en: "Concept, copy, code &amp; motion: Claude Fable 5 · Anthropic · 2026 — unofficial fan project"
  },

  /* UI */
  "lb.close": { de: "Schließen ✕", en: "Close ✕" },
  "cursor.open": { de: "Öffnen", en: "Open" }
};
